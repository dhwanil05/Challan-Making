...
const khushiCompany = {
  name: 'Rakeshbhai Mandaliya',
  tradeName: 'Khushi Fashion',
  gstin: '24AABCU9603R1ZM',
  address: '2nd Floor, Gothan Industries, Umiyadham, Surat',
  city: 'Surat',
  state: 'Gujarat',
  pincode: '395002',
  phone: '+91 9377172703',
  email: 'khushifashion@gmail.com',
  challanPrefix: 'KF',
  invoicePrefix: 'INV',
  challanCounter: 1,
  invoiceCounter: 1,
...
async function main() {
  ...
  // Always refresh password + company on re-seed so demo login works (update: {} used to leave stale hashes).
  ...
  console.log(`  Company: ${company.name} (${company.tradeName})`);
